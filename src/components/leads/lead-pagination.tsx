...
/**
 * Pagination controls for the lead list (docs/04 §4 paginated lists). URL-driven
 * (`?page=`), prev/next as links with a disabled state at the bounds. Announces
 * the current page via a live region for screen readers (WCAG 4.1.3).
 */
